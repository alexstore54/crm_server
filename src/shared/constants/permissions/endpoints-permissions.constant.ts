import {
  ...
  READ_AGENTS_PERMISSIONS, READ_DESK_PERMISSIONS, READ_ROLE_PERMISSIONS, READ_TEAMS_PERMISSIONS,
...
export const ENDPOINTS_PERMISSIONS = {
  AGENTS: {
    ...
    GET_ONE: [...READ_AGENTS_PERMISSIONS, PermissionsKeys.READ_ALL_AGENTS],
    GET_MANY: [...READ_AGENTS_PERMISSIONS, PermissionsKeys.READ_ALL_AGENTS],
  },
  MEDIA: {
    GET_AGENT_IMAGE: [...READ_AGENTS_PERMISSIONS, PermissionsKeys.READ_ALL_AGENTS],
    GET_DESK_IMAGE: [...READ_DESK_PERMISSIONS],
    GET_TEAM_IMAGE: [...READ_TEAMS_PERMISSIONS, PermissionsKeys.READ_TEAMS],
    GET_ROLE_IMAGE: [...READ_ROLE_PERMISSIONS],
  },
  CURRENT_AGENT: {
